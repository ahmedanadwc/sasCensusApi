...
/**
******************************************************
* Appends two data sets while maintaining the longest 
* lengths of the variables across the two data sets,
* in order to prevent truncation.
* 
* <br><br>Usage Example:<br>
* %etl_appendShrunkData(p_baseDsName=WORK.TEST
* , p_dataDsName=SASHELP.PRDSALE);<br>
*
* @param p_baseDsName Data set name to be appended to
* @param p_dataDsName Data set name to be appended
* @param p_tmpltDsName Template data set name 
*                      containing required column 
*                      attributes
* @param p_moveData_yn Y/N Flag to process the data,
*                      Default:Y
******************************************************
*/
...
*----------+----------+-----------------------------
* alatt001 |11/18/2020|Initial creation
* alatt001 |11/25/2020|Added/Modified code to support
*          |          |two new parameters:
*          |          |- p_tmpltDsName
*          |          |- p_moveData_yn
* alatt001 |03/21/2022|Added new code to handle name 
*          |          |literals
*          |          |
******************************************************
*/
